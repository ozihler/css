...
* No Spring, Lombok, messaging, CQRS, event sourcing, Kubernetes, H2, or fake authentication.
* The Angular admin UI is isolated in the repository's `frontend` module and consumes only the HTTP API.
